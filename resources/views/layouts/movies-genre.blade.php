    ...
    <div class="col-12 inner-background-color border py-2 mb-3">
        ...
        <div class="row ">
            <div class="col d-flex justify-content-center pag-links ">
                @if ($page_num != 1)
                <button class="btn btn-primary me-2 text-uppercase"><a href="{{route('movies-genre',['genre'=>$genre_id,'page_num'=>$page_num-1])}}">pervious page</a></button>                   
                @endif
                <button class="btn btn-primary text-uppercase"><a href="{{route('movies-genre',['genre'=>$genre_id,'page_num'=>$page_num+1])}}">next page </a></button>
            </div>
        </div>
    </div>
</div>
